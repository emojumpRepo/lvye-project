package com.lvye.mindtrip.module.iot.gateway.config;

import com.lvye.mindtrip.module.iot.core.messagebus.core.IotMessageBus;
import com.lvye.mindtrip.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import com.lvye.mindtrip.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import com.lvye.mindtrip.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import com.lvye.mindtrip.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import com.lvye.mindtrip.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import com.lvye.mindtrip.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import com.lvye.mindtrip.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import com.lvye.mindtrip.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import com.lvye.mindtrip.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import com.lvye.mindtrip.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import com.lvye.mindtrip.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import com.lvye.mindtrip.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import com.lvye.mindtrip.module.iot.gateway.service.device.IotDeviceService;
import com.lvye.mindtrip.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "mindtrip.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "mindtrip.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "mindtrip.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "mindtrip.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
