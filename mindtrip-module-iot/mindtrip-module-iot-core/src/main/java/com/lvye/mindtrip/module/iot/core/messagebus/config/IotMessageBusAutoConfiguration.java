package com.lvye.mindtrip.module.iot.core.messagebus.config;

import com.lvye.mindtrip.framework.mq.redis.core.RedisMQTemplate;
import com.lvye.mindtrip.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.lvye.mindtrip.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.lvye.mindtrip.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.lvye.mindtrip.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.lvye.mindtrip.module.iot.core.messagebus.core.IotMessageBus;
import com.lvye.mindtrip.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.lvye.mindtrip.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.lvye.mindtrip.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
import com.lvye.mindtrip.module.iot.core.mq.producer.IotDeviceMessageProducer;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "mindtrip.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "mindtrip.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 MindtripRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.lvye.mindtrip.framework.mq.redis.config.MindtripRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "mindtrip.iot.message-bus", name = "type", havingValue = "redis")
