package com.lvye.mindtrip.module.iot.job.device;
...
import com.lvye.mindtrip.module.iot.framework.iot.config.MindtripIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private MindtripIotProperties iotProperties;
