package com.lvye.mindtrip.module.iot.service.alert;

import com.lvye.mindtrip.framework.common.pojo.PageResult;
import com.lvye.mindtrip.framework.common.util.object.BeanUtils;
import com.lvye.mindtrip.module.iot.controller.admin.alert.vo.config.IotAlertConfigPageReqVO;
import com.lvye.mindtrip.module.iot.controller.admin.alert.vo.config.IotAlertConfigSaveReqVO;
import com.lvye.mindtrip.module.iot.dal.dataobject.alert.IotAlertConfigDO;
import com.lvye.mindtrip.module.iot.dal.mysql.alert.IotAlertConfigMapper;
import com.lvye.mindtrip.module.iot.service.rule.scene.IotSceneRuleService;
...
import static com.lvye.mindtrip.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_NOT_EXISTS;
