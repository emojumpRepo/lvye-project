package com.lvye.mindtrip.module.promotion.service.banner;

import com.lvye.mindtrip.framework.common.pojo.PageResult;
import com.lvye.mindtrip.module.promotion.controller.admin.banner.vo.BannerCreateReqVO;
import com.lvye.mindtrip.module.promotion.controller.admin.banner.vo.BannerPageReqVO;
import com.lvye.mindtrip.module.promotion.controller.admin.banner.vo.BannerUpdateReqVO;
import com.lvye.mindtrip.module.promotion.convert.banner.BannerConvert;
import com.lvye.mindtrip.module.promotion.dal.dataobject.banner.BannerDO;
import com.lvye.mindtrip.module.promotion.dal.mysql.banner.BannerMapper;
...
import static com.lvye.mindtrip.module.promotion.enums.ErrorCodeConstants.BANNER_NOT_EXISTS;
