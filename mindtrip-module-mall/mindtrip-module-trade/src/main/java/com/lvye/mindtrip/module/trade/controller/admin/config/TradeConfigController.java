package com.lvye.mindtrip.module.trade.controller.admin.config;

import com.lvye.mindtrip.framework.common.pojo.CommonResult;
import com.lvye.mindtrip.module.trade.controller.admin.config.vo.TradeConfigRespVO;
import com.lvye.mindtrip.module.trade.controller.admin.config.vo.TradeConfigSaveReqVO;
import com.lvye.mindtrip.module.trade.convert.config.TradeConfigConvert;
...
public class TradeConfigController {
    ...
    @Value("${mindtrip.tencent-lbs-key}")
