package com.lvye.mindtrip.module.trade.service.brokerage;
...
import com.lvye.mindtrip.framework.mybatis.core.util.MyBatisUtils;
...
import com.lvye.mindtrip.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import com.lvye.mindtrip.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import com.lvye.mindtrip.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import com.lvye.mindtrip.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import com.lvye.mindtrip.module.trade.convert.brokerage.BrokerageRecordConvert;
import com.lvye.mindtrip.module.trade.dal.dataobject.brokerage.BrokerageRecordDO;
import com.lvye.mindtrip.module.trade.dal.dataobject.brokerage.BrokerageUserDO;
import com.lvye.mindtrip.module.trade.dal.dataobject.config.TradeConfigDO;
import com.lvye.mindtrip.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import com.lvye.mindtrip.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
import com.lvye.mindtrip.module.trade.service.config.TradeConfigService;
...
import static com.lvye.mindtrip.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.lvye.mindtrip.framework.common.util.collection.CollectionUtils.getMinValue;
import static com.lvye.mindtrip.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static com.lvye.mindtrip.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
