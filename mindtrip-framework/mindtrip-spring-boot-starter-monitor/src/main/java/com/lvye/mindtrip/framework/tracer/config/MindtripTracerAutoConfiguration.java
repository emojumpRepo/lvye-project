package com.lvye.mindtrip.framework.tracer.config;

import com.lvye.mindtrip.framework.common.enums.WebFilterOrderEnum;
import com.lvye.mindtrip.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "mindtrip.tracer", value = "enable", matchIfMissing = true)
public class MindtripTracerAutoConfiguration {
