 ...
 *      1）Spring Async：
 *          {@link com.lvye.mindtrip.framework.quartz.config.MindtripAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 MindtripSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.lvye.mindtrip.framework.tenant;
