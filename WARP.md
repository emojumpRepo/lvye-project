...
- **Frontend**: Multiple UI options available in `mindtrip-ui/` directory:
...
mvn test -pl mindtrip-module-system

# Start the server (from mindtrip-server directory)
mvn spring-boot:run
...
### Frontend (Vue/Vben)
Navigate to `mindtrip-ui/mindtrip-ui-admin-vben/` and use:
```bash
...
### Core Modules
- **mindtrip-dependencies**: Maven dependency management
- **mindtrip-framework**: Custom Spring Boot starters and framework extensions
- **mindtrip-server**: Main application server entry point
- **mindtrip-module-system**: Core system functionality (users, roles, permissions, tenants)
- **mindtrip-module-infra**: Infrastructure services (file storage, code generation, monitoring)

### Business Modules
- **mindtrip-module-bpm**: Workflow management (Flowable)
- **mindtrip-module-pay**: Payment system integration
- **mindtrip-module-member**: Member management
- **mindtrip-module-mall**: E-commerce functionality
- **mindtrip-module-crm**: Customer relationship management
- **mindtrip-module-erp**: Enterprise resource planning
- **mindtrip-module-ai**: AI integration features
- **mindtrip-module-iot**: IoT device management
- **mindtrip-module-mp**: WeChat Mini Program integration
- **mindtrip-module-psychology**: Psychology assessment system (custom module)

### Framework Components
Each `mindtrip-spring-boot-starter-*` provides specific functionality:
...
- **Application Config**: `mindtrip-server/src/main/resources/application*.yaml`
- **Maven Parent**: Root `pom.xml` defines module structure
- **Frontend Config**: `mindtrip-ui/mindtrip-ui-admin-vben/package.json`
...
### Code Generation
The system includes a powerful code generator at `mindtrip-module-infra`:
...
### Psychology Module
A custom module (`mindtrip-module-psychology`) provides:
...
- Plugin directory: `mindtrip-module-iot-plugins/`
