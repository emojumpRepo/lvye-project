...
import com.lvye.mindtrip.module.psychology.dal.dataobject.assessment.*;
import com.lvye.mindtrip.module.psychology.dal.dataobject.questionnaire.*;
import com.lvye.mindtrip.module.psychology.dal.mysql.assessment.*;
import com.lvye.mindtrip.module.psychology.dal.mysql.questionnaire.*;
...
import com.lvye.mindtrip.module.psychology.rule.strategy.impl.AbnormalFactorAggregationStrategy;
import com.lvye.mindtrip.module.psychology.rule.strategy.DimensionInterlockStrategy;
...
import com.lvye.mindtrip.module.psychology.dal.mysql.assessment.ModuleResultMapper;
import com.lvye.mindtrip.module.psychology.rule.strategy.impl.DefaultModuleResultStrategy;
import com.lvye.mindtrip.module.psychology.rule.strategy.impl.ModuleDimensionInterlockStrategy;
import com.lvye.mindtrip.module.psychology.rule.strategy.impl.MultiDimensionLinkageEvaluator;
    ...
    public AssessmentResultDO calculateAssessmentResult(Long assessmentId, Long scenarioId, Long studentProfileId, Long userId, String taskNo) {
        ...
        if (result != null) {
            ...
            List<AssessmentResultDO> existList = assessmentResultMapper.selectList(
                new com.lvye.mindtrip.framework.mybatis.core.query.LambdaQueryWrapperX<AssessmentResultDO>()
        ...
        for (AssessmentScenarioSlotDO slot : targetSlots) {
            ...
            for (ModuleResultConfigDO cfg : moduleConfigs) {
                ...
                if (ev != null && ev.isMatched()) {
                    ...
                    String sc = com.lvye.mindtrip.module.psychology.util.StudentCommentUtils.selectRandomComment(cfg.getComments());
