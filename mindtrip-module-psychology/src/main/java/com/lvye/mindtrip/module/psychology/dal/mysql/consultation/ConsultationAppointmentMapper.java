...
import com.lvye.mindtrip.module.psychology.controller.admin.consultation.vo.appointment.ConsultationAppointmentPageReqVO;
...
public interface ConsultationAppointmentMapper extends BaseMapperX<ConsultationAppointmentDO> {
     ...
     * @return 今日咨询预约分页结果
     */
    default PageResult<ConsultationAppointmentDO> selectTodayPage(com.lvye.mindtrip.module.psychology.controller.admin.consultation.vo.appointment.ConsultationAppointmentTodayPageReqVO reqVO) {
