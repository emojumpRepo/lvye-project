...
public interface AssessmentUserTaskMapper extends BaseMapperX<AssessmentUserTaskDO> {
     ...
     * @return 测评任务列表
     */
    List<com.lvye.mindtrip.module.psychology.controller.admin.intervention.vo.CrisisEventRespVO.AssessmentTaskVO> selectAllTasksByEventIdAndUserId(@Param("eventId") Long eventId, @Param("userId") Long userId);
     ...
     * 统计：按年级/班级聚合
     */
    List<com.lvye.mindtrip.module.psychology.dal.dataobject.assessment.AssessmentDeptAggregationRow> selectAggregationByDept(@Param("taskNo") String taskNo);
