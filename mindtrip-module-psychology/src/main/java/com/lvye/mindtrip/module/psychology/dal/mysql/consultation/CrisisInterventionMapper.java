...
import com.lvye.mindtrip.module.psychology.controller.admin.intervention.vo.CrisisEventPageReqVO;
import com.lvye.mindtrip.module.psychology.controller.admin.intervention.vo.CrisisEventStatusStatisticsVO;
...
public interface CrisisInterventionMapper extends BaseMapperX<CrisisInterventionDO> {
     ...
     * @return 分页结果
     */
    default PageResult<CrisisInterventionDO> selectOngoingPage(com.lvye.mindtrip.framework.common.pojo.PageParam pageParam) {
