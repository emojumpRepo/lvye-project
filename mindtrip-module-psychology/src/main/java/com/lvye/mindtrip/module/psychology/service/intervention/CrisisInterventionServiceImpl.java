package com.lvye.mindtrip.module.psychology.service.intervention;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.RandomUtil;
import cn.hutool.core.util.StrUtil;
import com.lvye.mindtrip.framework.common.exception.util.ServiceExceptionUtil;
...
import com.lvye.mindtrip.module.psychology.controller.admin.intervention.vo.*;
...
import com.lvye.mindtrip.module.psychology.dal.mysql.consultation.CrisisEventAssessmentMapper;
...
import com.lvye.mindtrip.module.psychology.dal.mysql.intervention.InterventionLevelHistoryMapper;
import com.lvye.mindtrip.module.psychology.dal.mysql.profile.StudentInterventionMapper;
import com.lvye.mindtrip.module.psychology.dal.mysql.profile.StudentProfileMapper;
import com.lvye.mindtrip.module.psychology.enums.CrisisSourceTypeEnum;
...
import com.lvye.mindtrip.module.psychology.service.counselor.StudentCounselorAssignmentService;
import com.lvye.mindtrip.module.infra.service.config.ConfigService;
import com.lvye.mindtrip.module.infra.dal.dataobject.config.ConfigDO;
import com.lvye.mindtrip.module.psychology.enums.InterventionAssignmentModeEnum;
...
import com.lvye.mindtrip.module.system.dal.dataobject.permission.UserRoleDO;
import com.lvye.mindtrip.module.system.dal.dataobject.permission.UserDeptDO;
import com.lvye.mindtrip.module.system.enums.permission.RoleCodeEnum;
...
public class CrisisInterventionServiceImpl implements CrisisInterventionService {
    ...
    public InterventionAssignmentSettingVO getAssignmentSettings() {
        ...
        if (modeConfig == null) {
            ...
            var createModeReqVO = new com.lvye.mindtrip.module.infra.controller.admin.config.vo.ConfigSaveReqVO();
    ...
    public void setAssignmentSettings(InterventionAssignmentSettingVO settingVO) {
        ...
        var modeConfig = configService.getConfigByKey(CONFIG_KEY_ASSIGNMENT_MODE);
        if (modeConfig != null) {
            var updateModeReqVO = new com.lvye.mindtrip.module.infra.controller.admin.config.vo.ConfigSaveReqVO();
    ...
    @Override
    public PageResult<CrisisEventRespVO> getOngoingCrisisEventPage(com.lvye.mindtrip.framework.common.pojo.PageParam pageParam) {
        // 查询 status != 5 的分页数据
