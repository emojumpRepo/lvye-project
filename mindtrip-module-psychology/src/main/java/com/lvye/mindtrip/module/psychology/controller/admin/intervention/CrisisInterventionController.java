package com.lvye.mindtrip.module.psychology.controller.admin.intervention;
...
import com.lvye.mindtrip.module.psychology.service.intervention.CrisisInterventionService;
...
public class CrisisInterventionController {
    ...
    @PreAuthorize("@ss.hasPermission('psychology:intervention:query')")
    @DataPermission(enable = false)
    public CommonResult<PageResult<CrisisEventRespVO>> getOngoingCrisisEventPage(@Valid com.lvye.mindtrip.framework.common.pojo.PageParam pageParam) {
