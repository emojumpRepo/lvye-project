...
import com.lvye.mindtrip.module.psychology.controller.admin.assessment.vo.result.RiskLevelInterventionVO;
...
import com.lvye.mindtrip.module.psychology.framework.resultgenerator.vo.QuestionnaireResultVO;
...
import com.lvye.mindtrip.module.psychology.framework.resultgenerator.ResultGenerationContext;
import com.lvye.mindtrip.module.psychology.framework.resultgenerator.ResultGeneratorFactory;
import com.lvye.mindtrip.module.psychology.framework.resultgenerator.vo.AssessmentResultVO;
import com.lvye.mindtrip.module.psychology.service.questionnaire.QuestionnaireDimensionService;
import com.lvye.mindtrip.module.psychology.dal.mysql.questionnaire.DimensionResultMapper;
import com.lvye.mindtrip.module.psychology.dal.dataobject.questionnaire.DimensionResultDO;
import com.lvye.mindtrip.module.psychology.framework.resultgenerator.vo.QuestionnaireResultVO;
import com.lvye.mindtrip.module.psychology.service.assessment.ScenarioBasedAssessmentResultService;
import com.lvye.mindtrip.module.psychology.controller.app.assessment.vo.WebAssessmentParticipateReqVO.AssessmentAnswerItem;
...
public class AssessmentResultServiceImpl implements AssessmentResultService {
    ...
    private void recalculateQuestionnaireResult(QuestionnaireResultDO result) {
        ...
        // 获取计算服务
        com.lvye.mindtrip.module.psychology.service.questionnaire.QuestionnaireResultCalculateService calculateService =
            com.lvye.mindtrip.framework.common.util.spring.SpringUtils.getBean(
                com.lvye.mindtrip.module.psychology.service.questionnaire.QuestionnaireResultCalculateService.class);

        // 重新计算维度结果
        List<com.lvye.mindtrip.module.psychology.service.questionnaire.vo.QuestionnaireResultVO> calculatedResults;
        try {
    ...
    private void updateRecalculatedQuestionnaireResult(
        ...
        if (calculatedResults != null) {
            for (com.lvye.mindtrip.module.psychology.service.questionnaire.vo.QuestionnaireResultVO calcResult : calculatedResults) {
