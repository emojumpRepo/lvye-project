package com.lvye.mindtrip.module.infra.service.logger;
...
import com.lvye.mindtrip.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.lvye.mindtrip.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.lvye.mindtrip.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.lvye.mindtrip.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.lvye.mindtrip.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.lvye.mindtrip.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("mindtrip-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("mindtrip-test");
