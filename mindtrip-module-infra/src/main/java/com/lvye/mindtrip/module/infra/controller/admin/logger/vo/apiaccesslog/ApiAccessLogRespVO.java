package com.lvye.mindtrip.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.lvye.mindtrip.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
