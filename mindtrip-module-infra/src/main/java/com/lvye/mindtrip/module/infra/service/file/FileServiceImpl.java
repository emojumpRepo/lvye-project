...
import com.lvye.mindtrip.module.infra.controller.admin.file.vo.file.FileCreateReqVO;
import com.lvye.mindtrip.module.infra.controller.admin.file.vo.file.FilePageReqVO;
import com.lvye.mindtrip.module.infra.controller.admin.file.vo.file.FilePresignedUrlRespVO;
import com.lvye.mindtrip.module.infra.dal.dataobject.file.FileDO;
import com.lvye.mindtrip.module.infra.dal.mysql.file.FileMapper;
import com.lvye.mindtrip.module.infra.framework.file.core.client.FileClient;
import com.lvye.mindtrip.module.infra.framework.file.core.utils.FileTypeUtils;
...
import static com.lvye.mindtrip.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
...
public class FileServiceImpl implements FileService {
    ...
    public String createFile(byte[] content, String name, String directory, String type) {
        FileDO fileDO = createFileAndReturnDO(content, name, directory, type);
        return fileDO.getUrl();
    }

    @Override
    @SneakyThrows
    public FileDO createFileAndReturnDO(byte[] content, String name, String directory, String type) {
        // 1.1 处理 type 为空的情况
