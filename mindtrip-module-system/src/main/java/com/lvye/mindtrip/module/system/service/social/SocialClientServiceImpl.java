package com.lvye.mindtrip.module.system.service.social;
...
import com.lvye.mindtrip.framework.common.util.cache.CacheUtils;
import com.lvye.mindtrip.framework.common.util.http.HttpUtils;
import com.lvye.mindtrip.framework.common.util.object.BeanUtils;
import com.lvye.mindtrip.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.lvye.mindtrip.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.lvye.mindtrip.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.lvye.mindtrip.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.lvye.mindtrip.module.system.dal.dataobject.social.SocialClientDO;
import com.lvye.mindtrip.module.system.dal.mysql.social.SocialClientMapper;
import com.lvye.mindtrip.module.system.dal.redis.RedisKeyConstants;
import com.lvye.mindtrip.module.system.enums.social.SocialTypeEnum;
import com.lvye.mindtrip.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.lvye.mindtrip.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.lvye.mindtrip.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${mindtrip.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${mindtrip.wxa-subscribe-message.miniprogram-state:formal}")
