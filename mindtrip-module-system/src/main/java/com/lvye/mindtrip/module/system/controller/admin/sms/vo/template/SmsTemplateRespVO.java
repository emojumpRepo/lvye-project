package com.lvye.mindtrip.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "mindtrip")
    @ExcelProperty("模板名称")
    private String name;
