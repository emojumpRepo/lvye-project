package com.lvye.mindtrip.module.system.dal.mysql.permission;
...
public interface UserRoleMapper extends BaseMapperX<UserRoleDO> {
     ...
     * @return 用户及角色信息列表
     */
    List<com.lvye.mindtrip.module.system.controller.admin.user.vo.user.UserWithRoleInfoRespVO> selectNonStudentUsersWithRoles();
