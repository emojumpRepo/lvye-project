package com.lvye.mindtrip.module.system.service.user;
...
import com.lvye.mindtrip.framework.common.util.collection.ArrayUtils;
...
import com.lvye.mindtrip.module.infra.api.file.FileApi;
import com.lvye.mindtrip.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.lvye.mindtrip.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.lvye.mindtrip.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.lvye.mindtrip.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.lvye.mindtrip.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.lvye.mindtrip.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import com.lvye.mindtrip.module.system.dal.dataobject.dept.UserPostDO;
import com.lvye.mindtrip.module.system.dal.dataobject.tenant.TenantDO;
import com.lvye.mindtrip.module.system.dal.dataobject.user.AdminUserDO;
import com.lvye.mindtrip.module.system.dal.mysql.dept.UserPostMapper;
import com.lvye.mindtrip.module.system.dal.mysql.user.AdminUserMapper;
import com.lvye.mindtrip.module.system.enums.common.SexEnum;
import com.lvye.mindtrip.module.system.service.dept.DeptService;
import com.lvye.mindtrip.module.system.service.dept.PostService;
import com.lvye.mindtrip.module.system.service.permission.PermissionService;
import com.lvye.mindtrip.module.system.service.tenant.TenantService;
...
import static com.lvye.mindtrip.framework.common.util.collection.SetUtils.asSet;
...
import static com.lvye.mindtrip.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("mindtripyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("mindtripyuanma");
        ...
        assertEquals("mindtripyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("mindtripyuanma"))).thenReturn("java");
