package com.lvye.mindtrip.module.bpm.service.task;
...
import com.lvye.mindtrip.framework.common.util.object.PageUtils;
import com.lvye.mindtrip.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.lvye.mindtrip.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.lvye.mindtrip.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.lvye.mindtrip.module.bpm.controller.admin.task.vo.instance.*;
import com.lvye.mindtrip.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.lvye.mindtrip.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.lvye.mindtrip.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.lvye.mindtrip.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.lvye.mindtrip.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.lvye.mindtrip.module.bpm.enums.ErrorCodeConstants;
import com.lvye.mindtrip.module.bpm.enums.definition.BpmModelTypeEnum;
import com.lvye.mindtrip.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.lvye.mindtrip.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.lvye.mindtrip.module.bpm.enums.task.BpmReasonEnum;
import com.lvye.mindtrip.module.bpm.enums.task.BpmTaskStatusEnum;
import com.lvye.mindtrip.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.lvye.mindtrip.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.lvye.mindtrip.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.lvye.mindtrip.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.lvye.mindtrip.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.lvye.mindtrip.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.lvye.mindtrip.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.lvye.mindtrip.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.lvye.mindtrip.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.lvye.mindtrip.module.bpm.service.definition.BpmProcessDefinitionService;
import com.lvye.mindtrip.module.bpm.service.message.BpmMessageService;
import com.lvye.mindtrip.module.system.api.dept.DeptApi;
import com.lvye.mindtrip.module.system.api.dept.dto.DeptRespDTO;
import com.lvye.mindtrip.module.system.api.user.AdminUserApi;
import com.lvye.mindtrip.module.system.api.user.dto.AdminUserRespDTO;
...
import static com.lvye.mindtrip.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.lvye.mindtrip.module.bpm.enums.ErrorCodeConstants.*;
import static com.lvye.mindtrip.module.bpm.enums.task.BpmReasonEnum.REJECT_CHILD_PROCESS;
import static com.lvye.mindtrip.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.lvye.mindtrip.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
