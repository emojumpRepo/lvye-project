package com.lvye.mindtrip.module.bpm.framework.flowable.core.behavior;

import cn.hutool.core.collection.CollUtil;
import com.lvye.mindtrip.framework.common.util.collection.SetUtils;
import com.lvye.mindtrip.module.bpm.enums.definition.BpmChildProcessMultiInstanceSourceTypeEnum;
...
public class BpmSequentialMultiInstanceBehavior extends SequentialMultiInstanceBehavior {
    ...
    protected void executeOriginalBehavior(DelegateExecution execution, ExecutionEntity multiInstanceRootExecution, int loopCounter) {
        // 参见 https://gitee.com/zhijiantianya/mindtrip-cloud/issues/IC239F
