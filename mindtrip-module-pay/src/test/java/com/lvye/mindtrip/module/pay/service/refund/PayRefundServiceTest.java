package com.lvye.mindtrip.module.pay.service.refund;

import cn.hutool.extra.spring.SpringUtil;
import com.lvye.mindtrip.framework.common.pojo.PageResult;
import com.lvye.mindtrip.module.pay.enums.PayChannelEnum;
import com.lvye.mindtrip.module.pay.framework.pay.core.client.PayClient;
import com.lvye.mindtrip.module.pay.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import com.lvye.mindtrip.module.pay.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import com.lvye.mindtrip.framework.test.core.ut.BaseDbAndRedisUnitTest;
import com.lvye.mindtrip.module.pay.api.refund.dto.PayRefundCreateReqDTO;
import com.lvye.mindtrip.module.pay.controller.admin.refund.vo.PayRefundExportReqVO;
import com.lvye.mindtrip.module.pay.controller.admin.refund.vo.PayRefundPageReqVO;
import com.lvye.mindtrip.module.pay.dal.dataobject.app.PayAppDO;
import com.lvye.mindtrip.module.pay.dal.dataobject.channel.PayChannelDO;
import com.lvye.mindtrip.module.pay.dal.dataobject.order.PayOrderDO;
import com.lvye.mindtrip.module.pay.dal.dataobject.refund.PayRefundDO;
import com.lvye.mindtrip.module.pay.dal.mysql.refund.PayRefundMapper;
import com.lvye.mindtrip.module.pay.dal.redis.no.PayNoRedisDAO;
import com.lvye.mindtrip.module.pay.enums.notify.PayNotifyTypeEnum;
...
import com.lvye.mindtrip.module.pay.framework.pay.config.PayProperties;
import com.lvye.mindtrip.module.pay.service.app.PayAppService;
import com.lvye.mindtrip.module.pay.service.channel.PayChannelService;
import com.lvye.mindtrip.module.pay.service.notify.PayNotifyService;
import com.lvye.mindtrip.module.pay.service.order.PayOrderService;
...
import static com.lvye.mindtrip.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.lvye.mindtrip.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.lvye.mindtrip.framework.common.util.json.JsonUtils.toJsonString;
import static com.lvye.mindtrip.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.lvye.mindtrip.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.lvye.mindtrip.framework.test.core.util.AssertUtils.assertServiceException;
import static com.lvye.mindtrip.framework.test.core.util.RandomUtils.randomPojo;
import static com.lvye.mindtrip.framework.test.core.util.RandomUtils.randomString;
import static com.lvye.mindtrip.module.pay.enums.ErrorCodeConstants.*;
