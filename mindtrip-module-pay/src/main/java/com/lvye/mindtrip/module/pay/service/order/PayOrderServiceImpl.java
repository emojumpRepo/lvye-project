...
import com.lvye.mindtrip.framework.common.util.date.LocalDateTimeUtils;
...
import com.lvye.mindtrip.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/mindtrip-cloud/issues/I8SM9H 场景
