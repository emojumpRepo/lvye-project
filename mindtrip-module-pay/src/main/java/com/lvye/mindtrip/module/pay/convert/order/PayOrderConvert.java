package com.lvye.mindtrip.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.lvye.mindtrip.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
