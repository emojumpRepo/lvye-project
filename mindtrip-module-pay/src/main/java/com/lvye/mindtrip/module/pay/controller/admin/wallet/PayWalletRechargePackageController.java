package com.lvye.mindtrip.module.pay.controller.admin.wallet;

import com.lvye.mindtrip.framework.common.pojo.CommonResult;
import com.lvye.mindtrip.framework.common.pojo.PageResult;
import com.lvye.mindtrip.module.pay.controller.admin.wallet.vo.rechargepackage.WalletRechargePackageCreateReqVO;
import com.lvye.mindtrip.module.pay.controller.admin.wallet.vo.rechargepackage.WalletRechargePackagePageReqVO;
import com.lvye.mindtrip.module.pay.controller.admin.wallet.vo.rechargepackage.WalletRechargePackageRespVO;
import com.lvye.mindtrip.module.pay.controller.admin.wallet.vo.rechargepackage.WalletRechargePackageUpdateReqVO;
import com.lvye.mindtrip.module.pay.convert.wallet.PayWalletRechargePackageConvert;
import com.lvye.mindtrip.module.pay.dal.dataobject.wallet.PayWalletRechargePackageDO;
import com.lvye.mindtrip.module.pay.service.wallet.PayWalletRechargePackageService;
