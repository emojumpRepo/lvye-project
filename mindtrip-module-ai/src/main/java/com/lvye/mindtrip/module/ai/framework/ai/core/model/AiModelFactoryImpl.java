package com.lvye.mindtrip.module.ai.framework.ai.core.model;
...
import com.lvye.mindtrip.framework.common.util.spring.SpringUtils;
import com.lvye.mindtrip.module.ai.enums.model.AiPlatformEnum;
import com.lvye.mindtrip.module.ai.framework.ai.config.AiAutoConfiguration;
import com.lvye.mindtrip.module.ai.framework.ai.config.MindtripAiProperties;
...
import com.lvye.mindtrip.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.lvye.mindtrip.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            MindtripAiProperties.Midjourney properties = SpringUtil.getBean(MindtripAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(MindtripAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        MindtripAiProperties.DouBao properties = new MindtripAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(MindtripAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        MindtripAiProperties.HunYuan properties = new MindtripAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(MindtripAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        MindtripAiProperties.SiliconFlow properties = new MindtripAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(MindtripAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        MindtripAiProperties.XingHuo properties = new MindtripAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(MindtripAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        MindtripAiProperties.BaiChuan properties = new MindtripAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(MindtripAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        MindtripAiProperties.Gemini properties = SpringUtil.getBean(MindtripAiProperties.class)
