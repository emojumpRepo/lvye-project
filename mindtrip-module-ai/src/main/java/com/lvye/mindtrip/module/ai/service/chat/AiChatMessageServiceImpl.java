package com.lvye.mindtrip.module.ai.service.chat;
...
import com.lvye.mindtrip.framework.tenant.core.util.TenantUtils;
import com.lvye.mindtrip.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.lvye.mindtrip.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.lvye.mindtrip.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.lvye.mindtrip.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.lvye.mindtrip.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.lvye.mindtrip.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.lvye.mindtrip.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.lvye.mindtrip.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.lvye.mindtrip.module.ai.dal.dataobject.model.AiModelDO;
import com.lvye.mindtrip.module.ai.dal.dataobject.model.AiToolDO;
import com.lvye.mindtrip.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.lvye.mindtrip.module.ai.enums.ErrorCodeConstants;
import com.lvye.mindtrip.module.ai.enums.model.AiPlatformEnum;
import com.lvye.mindtrip.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.lvye.mindtrip.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.lvye.mindtrip.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.lvye.mindtrip.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.lvye.mindtrip.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.lvye.mindtrip.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.lvye.mindtrip.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.lvye.mindtrip.module.ai.service.model.AiChatRoleService;
import com.lvye.mindtrip.module.ai.service.model.AiModelService;
import com.lvye.mindtrip.module.ai.service.model.AiToolService;
import com.lvye.mindtrip.module.ai.util.AiUtils;
import com.lvye.mindtrip.module.ai.util.FileTypeUtils;
...
import static com.lvye.mindtrip.framework.common.pojo.CommonResult.error;
...
import static com.lvye.mindtrip.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.lvye.mindtrip.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 mindtrip.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 mindtrip.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
