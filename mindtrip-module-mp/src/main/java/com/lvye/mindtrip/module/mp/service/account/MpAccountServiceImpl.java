package com.lvye.mindtrip.module.mp.service.account;
...
import com.lvye.mindtrip.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.lvye.mindtrip.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.lvye.mindtrip.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.lvye.mindtrip.module.mp.convert.account.MpAccountConvert;
import com.lvye.mindtrip.module.mp.dal.dataobject.account.MpAccountDO;
import com.lvye.mindtrip.module.mp.dal.mysql.account.MpAccountMapper;
import com.lvye.mindtrip.module.mp.enums.ErrorCodeConstants;
...
import static com.lvye.mindtrip.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 mindtrip-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
