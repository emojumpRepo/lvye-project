package com.lvye.mindtrip.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.thread.ThreadUtil;
import cn.hutool.core.util.StrUtil;
import com.lvye.mindtrip.framework.common.pojo.PageResult;
import com.lvye.mindtrip.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.lvye.mindtrip.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.lvye.mindtrip.module.mp.convert.message.MpMessageConvert;
import com.lvye.mindtrip.module.mp.dal.dataobject.account.MpAccountDO;
import com.lvye.mindtrip.module.mp.dal.dataobject.message.MpMessageDO;
import com.lvye.mindtrip.module.mp.dal.dataobject.user.MpUserDO;
import com.lvye.mindtrip.module.mp.dal.mysql.message.MpMessageMapper;
import com.lvye.mindtrip.module.mp.enums.message.MpMessageSendFromEnum;
import com.lvye.mindtrip.module.mp.framework.mp.core.MpServiceFactory;
import com.lvye.mindtrip.module.mp.framework.mp.core.util.MpUtils;
import com.lvye.mindtrip.module.mp.service.account.MpAccountService;
import com.lvye.mindtrip.module.mp.service.material.MpMaterialService;
import com.lvye.mindtrip.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.lvye.mindtrip.module.mp.service.user.MpUserService;
...
import static com.lvye.mindtrip.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
